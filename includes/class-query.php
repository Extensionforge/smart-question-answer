...
abstract class SmartQa_Query {
	...
	public function total_count( $key ) {
		global $wpdb;
		$this->total_count = $wpdb->get_var( apply_filters( 'asqa_found_rows', 'SELECT FOUND_ROWS()', $this ) ); // phpcs:ignore WordPress.DB
	}
	...
	public function template( $template ) {
		include asqa_get_theme_location( $template . '.php' );
	}
