...
namespace Smartqa\Addons\Avatar;
...
class Generator {
	...
	public function colors() {
		 ...
		 * @return array
		 */
		$this->colors = apply_filters( 'asqa_addon_avatar_colors', $colors );
	}
	...
	public function fileurl() {
		$upload_dir = wp_upload_dir();
		$avatar_dir = $upload_dir['baseurl'] . '/asqa_avatars';
	...
	public function generate() {
		...
		$font  = asqa_get_theme_location( 'avatar-fonts/' . asqa_opt( 'avatar_font' ) . '.ttf' );
