...
if ( 'comment' === $type && asqa_user_can_read_comment( $this->object->c_id ) ) {
	echo wp_kses_post( get_comment_excerpt( $this->object->c_id ) ) . '<a href="' . esc_url( asqa_get_short_link( array( 'asqa_c' => $this->object->c_id ) ) ) . '">' . esc_attr__( 'View comment', 'smart-question-answer' ) . '</a>';
